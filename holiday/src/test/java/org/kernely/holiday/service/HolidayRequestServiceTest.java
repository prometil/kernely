...
public class HolidayRequestServiceTest extends AbstractServiceTest{
	...
	private void createHolidayRequestForUser(long userId, long id){
	...
	public void registerRequestTest(){
		...
		assertEquals(getAvailableForTheYear(balance) - 2.5, balance.availableBalanceUpdated, 0);
	...
	public void waitingRequestTest(){
		...
		assertEquals(getAvailableForTheYear(balance) - 1.5F, balance.availableBalanceUpdated, 0);
		assertEquals(30, balance.availableBalance, 0);
	}
	...
	public void acceptRequestTest(){
		...
		dtos = holidayRequestService.getSpecificRequestsForManagers(HolidayRequest.PENDING_STATUS, -1);
		assertEquals(1, dtos.size());
	...
	public void commentManagerRequestTest(){
		...
		authenticateAs(USERNAME_MANAGER);
		List<HolidayRequestDTO> dtos = holidayRequestService.getSpecificRequestsForManagers(HolidayRequest.PENDING_STATUS, -1);
