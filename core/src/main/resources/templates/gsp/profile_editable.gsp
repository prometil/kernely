...
<script type="text/html" id="profile">
	...
	<div id="profile_information" style="height:550px;width:545px;float:left;text-align:left;border-left:1px solid black; border-top:1px solid black; padding:15px;">
		<table style="width:100%" id="profile_table">
			<tr><td><%= i18n.t("civility") %></td>
			<td><span id="profile_civility" style="display: none;">${details.civility}</span><input type="radio" class="edit_button_civility" name="civility" value="1"> <%= i18n.t("civility.mister") %> <input type="radio" class="edit_button_civility" name="civility" value="2"> <%= i18n.t("civility.madam") %> <input type="radio" class="edit_button_civility" name="civility" value="3"> <%= i18n.t("civility.miss") %> </td><td></td></tr>
		</table>
	</div>
</div>
