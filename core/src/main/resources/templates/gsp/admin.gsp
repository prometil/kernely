...
<div id="admin_header" style="height:50px;text-align:center;font-size:20px;font-weight:bold;"><%= i18n.t("admin_page_title") %></div>
<div id="admin_sidebar_container" style="width:250px; float:left;">
