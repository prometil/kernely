...
public class InvoiceCreationRequestDTO {
	...
	/**
	 * String representation of the term date of this invoice
	 */
	 ...
	 */
	public InvoiceCreationRequestDTO(long id, String code, String object, String datePublication, String dateTerm, long projectId, String comment, float amount){
		this.id = id;
		this.code = code;
		this.object = object;
